...
exports.MerchandiseCollections1598593350442 = void 0;
const MerchandiseCollectionModel_1 = require("../models/MerchandiseCollectionModel");
class MerchandiseCollections1598593350442 {
    up(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            yield queryRunner.manager.getRepository(MerchandiseCollectionModel_1.MerchandiseCollectionModel).save([
                {
    ...
    down(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            yield queryRunner.manager.createQueryBuilder().delete().from(MerchandiseCollectionModel_1.MerchandiseCollectionModel).execute();
        });
    }
}
exports.MerchandiseCollections1598593350442 = MerchandiseCollections1598593350442;
